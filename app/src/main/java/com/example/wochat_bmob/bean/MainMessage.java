...
public abstract class MainMessage implements Serializable,Comparable {
    ...
    public boolean equals(Object o) {
        ...
        MainMessage that = (MainMessage) o;
    ...
    public int compareTo(Object another) {
        if (another instanceof MainMessage){
            MainMessage anotherConversation = (MainMessage) another;
